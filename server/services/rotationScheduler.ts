...
import { performRotation, DEFAULT_ROTATION_CRON } from '~/server/utils/rotation'
...
export function syncRotationSchedule(cron: string | null | undefined, fallback?: string) {
