...
const onSubmit = handleSubmit(async (values) => {
  ...
  try {
    ...
    error.value =
      e?.data?.statusMessage || e?.message || "Registrierung fehlgeschlagen."
  }
})
</script>
...
<template>
  <div class="text-center py-6">
    ...
    <p class="text-gray-600 mb-6">
      Danke, dass du diese App aufgesetzt hast. Erstelle das erste Admin-Konto,
      um zu beginnen. Keine Ahnung, was auf dich zukommt? Keine Angst, lies am
      besten die Anleitung.
    </p>
  </div>
